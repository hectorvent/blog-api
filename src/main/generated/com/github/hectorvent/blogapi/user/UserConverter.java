...
/**
 * Converter for {@link com.github.hectorvent.blogapi.user.User}.
 * NOTE: This class has been automatically generated from the {@link com.github.hectorvent.blogapi.user.User} original class using Vert.x codegen.
 */
      ...
      switch (member.getKey()) {
        ...
        case "token":
          if (member.getValue() instanceof JsonObject) {
            obj.setToken(new com.github.hectorvent.blogapi.user.Token((JsonObject)member.getValue()));
          }
          break;
      }
    }
